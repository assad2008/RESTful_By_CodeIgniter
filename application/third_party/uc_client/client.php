...
define('UC_API', 'http://bbs.8783.com/uc_server');
...
define('UC_DBHOST', 'mysql-db');
define('UC_DBUSER', 'forumuser');
define('UC_DBPW', 'forumuser_1024');
...
function uc_get_user_byemail($email)
{
	$return = call_user_func(UC_API_FUNC, 'user', 'get_user_byemail', array('email'=>$email));
	return UC_CONNECT == 'mysql' ? $return : uc_unserialize($return);
}
